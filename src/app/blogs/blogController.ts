...
export const createBlog = catchAsync(async (req: Request, res: Response): Promise<any> => {
...
export const updateBlog = catchAsync(async (req: Request, res: Response): Promise<any> => {
...
export const deleteBlog = catchAsync(async (req: Request, res: Response): Promise<any> => {
